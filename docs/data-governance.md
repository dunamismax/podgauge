...
| User-submitted public fixtures             | `docs/fixture-contributions.md`, contributor authority, consent, privacy, removal route, MIT project license, and a separate fixture grant | Only accepted fixture fields after intake opens                       | Only under recorded fixture grant and project policy | Contributor-chosen credit or documented anonymous consent                      | Per contribution                     | Blocked until intake explicitly opens |
